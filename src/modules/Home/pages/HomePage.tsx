...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#090b14] text-slate-100 selection:bg-indigo-500/30 selection:text-indigo-200">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="mt-10 grid grid-cols-2 gap-3 sm:grid-cols-4 max-w-3xl mx-auto">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm">
              ...
              <span className="text-xs text-slate-400 font-medium">Regional Languages</span>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm">
              <span className="block text-2xl font-black text-indigo-400">100%</span>
              <span className="text-xs text-slate-400 font-medium">NTA Standard GUI</span>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm">
              <span className="block text-2xl font-black text-purple-400">99.8%</span>
              <span className="text-xs text-slate-400 font-medium">AI Rank Precision</span>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm">
              <span className="block text-2xl font-black text-emerald-400">0 ms</span>
              <span className="text-xs text-slate-400 font-medium">In-Flight Lang Switch</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="test-series" className="py-12 border-t border-white/8 bg-[#0b0e1b]/60">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
            ...
            <div className="relative w-full md:w-72">
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/10 bg-white/5 pl-9 pr-4 py-2 text-xs text-white placeholder-slate-500 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
              />
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2 mb-8">
            <span className="flex items-center gap-1 text-xs font-semibold text-slate-400 mr-2">
              <Filter size={13} />
          ...
          {isLoading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[1, 2, 3, 4, 5, 6].map((idx) => (
                <div
                  key={idx}
                  className="h-64 rounded-2xl border border-white/10 bg-white/5 animate-pulse p-6 flex flex-col justify-between"
                >
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-12 text-center max-w-md mx-auto my-8">
              <BookOpen size={40} className="mx-auto text-slate-500 mb-3" />
              <h3 className="text-base font-bold text-white">No Test Series Found</h3>
              <p className="text-xs text-slate-400 mt-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredExams.map((exam) => {
                ...
                return (
                  <div
                    key={exam.id}
                    className="group relative rounded-2xl border border-white/10 bg-[#121528] p-6 shadow-xl hover:border-indigo-500/40 hover:shadow-2xl hover:shadow-indigo-500/10 transition-all flex flex-col justify-between"
                  >
                    {/* Top Badges */}
                    <div>
                      ...
                      {/* Test Specs Grid */}
                      <div className="mt-4 grid grid-cols-3 gap-2 rounded-xl bg-white/5 p-3 text-center border border-white/5">
                        <div>
                        ...
                        <div>
                          ...
                          <span className="text-sm font-bold text-white">{exam.totalMarks} M</span>
                        </div>
                      </div>

                      {/* Multilingual Support Pill */}
                      <div className="mt-3.5 flex items-center gap-1.5 text-[11px] text-slate-300 bg-purple-500/10 border border-purple-500/20 rounded-lg px-2.5 py-1.5">
                    ...
                    <div className="mt-6 pt-4 border-t border-white/8">
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 via-indigo-500 to-purple-600 hover:from-indigo-500 hover:to-purple-500 px-4 py-2.5 text-xs font-bold text-white shadow-lg shadow-indigo-500/25 transition-all group-hover:scale-[1.02] active:scale-95"
                      >
      ...
      <section id="languages" className="py-16 border-t border-white/8 bg-[#090b14]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-5 md:grid-cols-9 gap-3">
            {SUPPORTED_EXAM_LANGUAGES.map((lang) => (
              <div
                key={lang.code}
                className="rounded-2xl border border-white/10 bg-white/5 p-3.5 text-center hover:border-indigo-500/50 hover:bg-indigo-500/10 transition-all group"
              >
                <span className="block text-base font-bold text-white group-hover:text-indigo-300">
                  {lang.nativeName}
                </span>
      ...
      <section id="features" className="py-16 border-t border-white/8 bg-[#0b0e1b]/80">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="rounded-2xl border border-white/10 bg-[#121528] p-6">
              <div className="h-10 w-10 rounded-xl bg-indigo-500/20 text-indigo-400 flex items-center justify-center mb-4">
                <ShieldCheck size={20} />
              </div>
              <h3 className="text-base font-bold text-white">Authoritative Server Timing</h3>
            ...
            <div className="rounded-2xl border border-white/10 bg-[#121528] p-6">
              ...
              <h3 className="text-base font-bold text-white">Deep Diagnostic Analysis</h3>
              <p className="mt-2 text-xs text-slate-400 leading-relaxed">
            ...
            <div className="rounded-2xl border border-white/10 bg-[#121528] p-6">
              ...
              <h3 className="text-base font-bold text-white">AI Rank & Percentile Prediction</h3>
              <p className="mt-2 text-xs text-slate-400 leading-relaxed">
      ...
      {/* ══ FOOTER ══════════════════════════════════════════════════ */}
      <footer className="border-t border-white/8 bg-[#07080f] py-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-slate-300">BRAINROS MOCK LMS</span>
            <span>&copy; {new Date().getFullYear()} All rights reserved.</span>
          </div>
          <div className="flex items-center gap-4">
            <Link to={PUBLIC_NAVIGATION.login} className="hover:text-slate-300 transition-colors">
              Student Login
            </Link>
            <Link
            ...
            <a href="#test-series" className="hover:text-slate-300 transition-colors">
              Test Series
            </a>
          </div>
        </div>
