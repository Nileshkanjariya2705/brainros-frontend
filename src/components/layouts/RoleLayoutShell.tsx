...
export const ROLE_THEMES: Record<string, RoleThemeConfig> = {
  ...
  GENERAL_MANAGER: {
    brandGradient: 'from-indigo-800 to-slate-900',
    activeLinkBg: 'bg-indigo-50',
    activeLinkText: 'text-indigo-700',
    activeLinkBorder: 'border-indigo-100',
    headerBorder: 'border-slate-200',
    ...
    profileHoverBg: 'hover:bg-indigo-50/70',
    profileHoverBorder: 'hover:border-indigo-200',
    brandIconBg: 'bg-gradient-to-br from-indigo-700 to-slate-900',
  },
  MANAGER: {
    brandGradient: 'from-blue-700 to-indigo-900',
    activeLinkBg: 'bg-blue-50',
    activeLinkText: 'text-blue-700',
    activeLinkBorder: 'border-blue-100',
    headerBorder: 'border-slate-200',
    ...
    profileHoverBg: 'hover:bg-blue-50/70',
    profileHoverBorder: 'hover:border-blue-200',
    brandIconBg: 'bg-gradient-to-br from-blue-600 to-indigo-800',
  },
  OPERATOR: {
    brandGradient: 'from-cyan-700 to-slate-800',
    activeLinkBg: 'bg-cyan-50',
    activeLinkText: 'text-cyan-700',
    activeLinkBorder: 'border-cyan-100',
    headerBorder: 'border-slate-200',
    bellAccent: 'bg-cyan-600',
    profileHoverBg: 'hover:bg-cyan-50/70',
    profileHoverBorder: 'hover:border-cyan-200',
    brandIconBg: 'bg-gradient-to-br from-cyan-600 to-slate-800',
  },
  ACCOUNTANT: {
    brandGradient: 'from-amber-700 to-slate-800',
    activeLinkBg: 'bg-amber-50',
    activeLinkText: 'text-amber-700',
    activeLinkBorder: 'border-amber-100',
    headerBorder: 'border-slate-200',
    bellAccent: 'bg-amber-600',
    profileHoverBg: 'hover:bg-amber-50/70',
    profileHoverBorder: 'hover:border-amber-200',
    brandIconBg: 'bg-gradient-to-br from-amber-600 to-slate-800',
  },
  SALES_AGENT: {
    brandGradient: 'from-emerald-700 to-teal-900',
    activeLinkBg: 'bg-emerald-50',
    activeLinkText: 'text-emerald-700',
    activeLinkBorder: 'border-emerald-100',
    headerBorder: 'border-slate-200',
    bellAccent: 'bg-emerald-600',
    profileHoverBg: 'hover:bg-emerald-50/70',
    profileHoverBorder: 'hover:border-emerald-200',
    brandIconBg: 'bg-gradient-to-br from-emerald-600 to-teal-800',
  },
};
